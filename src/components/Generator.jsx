        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border duration-200 px-4 rounded-lg hover:border-blue-600 py-3 " +
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border px-4 duration-200 rounded-lg hover:border-blue-600 py-3 " +
